...
resource "google_dns_record_set" "bergmans_txt_domainkey" {
  managed_zone = google_dns_managed_zone.bergmans.name
...
resource "google_dns_record_set" "bergmanhouse_cname_grafana" {
  managed_zone = google_dns_managed_zone.bergmanhouse.name
...
resource "google_dns_record_set" "bergmanhouse_cname_hass" {
  managed_zone = google_dns_managed_zone.bergmanhouse.name
...
resource "google_dns_record_set" "bergmanhouse_cname_hedwig" {
  managed_zone = google_dns_managed_zone.bergmanhouse.name
...
resource "google_dns_record_set" "bergmanhouse_cname_mon" {
  managed_zone = google_dns_managed_zone.bergmanhouse.name
...
resource "google_dns_record_set" "bergmanhouse_cname_plex" {
  managed_zone = google_dns_managed_zone.bergmanhouse.name
...
resource "google_dns_record_set" "bergmanhouse_cname_unifi" {
  managed_zone = google_dns_managed_zone.bergmanhouse.name
...
resource "google_dns_record_set" "boozyprofessor_a_mail" {
  managed_zone = google_dns_managed_zone.boozyprofessor.name
...
resource "google_dns_record_set" "maunder_a_mail" {
  managed_zone = google_dns_managed_zone.maunder.name
